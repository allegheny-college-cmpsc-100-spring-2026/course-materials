...
>
> _Donald Knuth_, an absolute :goat:
...
|--------------------------|--------------|------------|--------------------------------|
|Monday, Wednesday, Friday |9:00 - 9:50   |Activities  |Alden 101                       |
...
The instructor's office hours are posted to an [appointment scheduling system](https://chompe.rs/office-hours). Where
possible, reserve appointments using this system. 
...
#### Distribution Requirement Objectives

#####  Modes of Expression (ME)

The study of Modes of Expression explores individual and/or collective modes of expression, focusing upon the ways in which these modes create meaning and communicate thoughts, emotions, or beliefs to others. By engaging in hands-on experience, students interrogate the act of communication itself.

###### Learning Outcome

Students who successfully complete this requirement will demonstrate an understanding of the production of meaning through active engagement with language, visual arts, and/or performance.
...
Github is an industry-standard system for storing and _versioning_ (keeping working and finished copies of) software.
...
The [Discord chat platform](https://discord.com) serves as the primary communications channel for course information. As courses in the CIS Department feature additional context or extended Q&A, it's importnant for students to keep up-to-date on posts to 
the channel. The instructor recommends that students download and install the destop application for Discord to monitor
channel activity. 

#### Grading and Evaluation

Given the technical nature of work in disciplines related to computer science, you may be tempted to think that this
...
Final grading represents these categories in the following schedule:

|Evaluation Type |Points Possible  |
|:---------------|:----------------|
|Class Activities|15               |
|Lab Assignments |50               |
|Final Project   |35               |
...
Grades will be reported to our course's [`Canvas`](https://allegheny.instructure.com) gradebook.
...
requirements. Students will be able to use the `gatorgrade` tool to assess their progress on these technical requirements.

##### Final Project

In the closing weeks of the semester, students will engage in a final project that represents their cumulative learning
over the course of the semester. Like [Lab Assignments](#lab-assignments), this project will feature code review and
various techical benchmarks.

### Policies

This course follows [CIS Department policies](https://www.cis.allegheny.edu/teaching/policies/) with some additions described
below.

#### Attendance

General department policy allows for no more than two weeks of absences without the impact to the course grade. In this class, this means that for each 8 sessions for which a student is absent, their letter grade will be reduced _one full letter_.
...
As an introductory course, you have `4` tokens. Each can do one of the following:
- Extend one assignment's deadline by two weeks
...
Students who struggle to understand knowledge and skills defined in this course are encouraged to seek assistance from the instructor. See the instructor's office hours schedule under the [Important Resources](#important-resources) heading above.
